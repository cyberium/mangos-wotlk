...
class ObjectMgr
{
    ...
    public:
        ...
        * \param CreatureInfo const* cinfo  creature data from creature_template table
        ...
        * Qualifier: const
        **/
        CreatureClassLvlStats const* GetCreatureClassLvlStats(CreatureInfo const *cinfo, uint32 level) const;
    protected:
    ...
    private:
        ...
        CreatureClassLvlStats m_creatureClassLvlStats[MAX_CREATURE_LEVEL + 1][MAX_CREATURE_CLASS][MAX_EXPANSION + 1];
